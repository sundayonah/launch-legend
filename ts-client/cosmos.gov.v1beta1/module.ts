...
export { QueryVotesRequest, QueryVotesResponse, QueryDepositsResponse, TextProposal, Proposal, TallyResult, QueryProposalRequest, QueryProposalResponse, QueryTallyResultRequest, Vote, GenesisState, QueryProposalsRequest, QueryParamsRequest, MsgVote, MsgVoteWeightedResponse, WeightedVoteOption, QueryParamsResponse, MsgDepositResponse, MsgVoteResponse, QueryDepositsRequest, MsgSubmitProposal, QueryDepositRequest, QueryDepositResponse, QueryProposalsResponse, QueryVoteResponse, DepositParams, TallyParams, Deposit, MsgSubmitProposalResponse, MsgVoteWeighted, MsgDeposit, VotingParams, QueryVoteRequest, QueryTallyResultResponse };
